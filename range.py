...
def halaman_rumah(main):
    ...
    utama = ImageTk.PhotoImage(Image.open('7.png'))
...
Harga: {rumah1['harga']}"""
    ...
    CTkButton(
        label_rum, text="",
        image=ImageTk.PhotoImage(Image.open("pilih.png").resize((300, 50), Image.LANCZOS)),  
...
Harga: {rumah2['harga']}"""
    ...
    CTkButton(
        label_rum, text="",  
        image=ImageTk.PhotoImage(Image.open("kir.png").resize((50, 50), Image.LANCZOS)),  
    ...
    CTkButton(
        label_rum, text="", 
        image=ImageTk.PhotoImage(Image.open("kan.png").resize((50, 50), Image.LANCZOS)),  
        cursor='hand2', command=lambda: next_rumah(2),
        fg_color="transparent", border_spacing=0
...
def halaman_pembayaran(main, rumah):
    ...
    try:
        background_image = Image.open("9.png")  
...
def halaman_pilihan_pembayaran(main, rumah):
    ...
    # Tombol cicil
    gambar_cicil = Image.open('cicil.png').resize((300, 60), Image.LANCZOS)
    ...
    # Tombol lunas
    gambar_lunas = Image.open('lunas.png').resize((300, 60), Image.LANCZOS)
