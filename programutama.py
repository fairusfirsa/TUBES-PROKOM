...
def halaman1(main):
    ...
    utama = ImageTk.PhotoImage(Image.open('bg/1.png'))
    ...
    # Tombol Next
    gambar_next = Image.open('bg/next.png').resize((300, 60), Image.LANCZOS)
...
def halaman_login(main):
    ...
    bg_login = ImageTk.PhotoImage(Image.open('bg/3.png')) 
    ...
    show_img = Image.open('bg/oeye.png')  
    hide_img = Image.open('bg/heye.png')
...
def halaman_signup(main):
    ...
    bg_signup = ImageTk.PhotoImage(Image.open('bg/4.png'))  
...
def halaman3(main, user_email):
    ...
    utama = ImageTk.PhotoImage(Image.open('bg/2.png'))
    label = tk.Label(frame3, image=utama)
    label.pack(fill=tk.BOTH, expand=tk.YES)

    rekomen = Image.open('bg/rekomen.png').resize((300, 60), Image.LANCZOS)
    ...
    # Tombol Hitung
    hitung = Image.open('bg/hitung.png').resize((300, 60), Image.LANCZOS)
...
def halaman_hitung(main, user_email):
    ...
    bg_hitung_img = Image.open('bg/5.png')  
    ...
    # halaman rekomen
    gambar_next = Image.open('bg/rekomen.png').resize((300, 60), Image.LANCZOS)
    gambar_next2 = ImageTk.PhotoImage(gambar_next)
    tombolnext = CTkButton(
...
def halaman_rekomen(main):
    ...
    gambar_rek = ImageTk.PhotoImage(Image.open('bg/8.png').resize((1920, 1080), Image.LANCZOS))
